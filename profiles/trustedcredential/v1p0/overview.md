...
## Overview
The TrustEd Credential Profile for Open Badges 3.0 (OB3) defines a structured and interoperable approach for representing high-quality digital credentials. The profile establishes additional requirements and guidance for the use of existing OB3 properties, including achievementType, criteria, alignment, result, and evidence, to improve consistency, transparency, and interpretability.

The profile introduces conventions for representing distinct categories of achievement, specifically knowledge-based and application-based credentials, and defines expectations for how assessment, skills alignment, and outcomes are expressed. These conventions enable conformant systems to consistently interpret credential meaning and level of achievement without reliance on issuer-specific context.
...
The TrustEd Credential Profile addresses these challenges by defining required and recommended usage patterns for OB3 properties, enabling consistent, machine-readable representation of credential quality, assessment, and outcomes.
...
For issuers:
	•	Provides implementation guidance for consistent use of OB3 properties such as criteria, alignment, result, and evidence.
