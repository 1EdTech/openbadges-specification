...
<a id="revokedAssertions"></a> **revokedAssertions** | `Assertion` ([Multiple values allowed](#array)) | An array of string `id` or UID-based identifications of assertion objects that have been revoked.
