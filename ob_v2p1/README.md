# Open Badges 2.1 Badge Connect&reg; API
This is the repository for the IMS Global Badge Connect&reg; API specification. This specification will be released as Open Badges v2.1.
