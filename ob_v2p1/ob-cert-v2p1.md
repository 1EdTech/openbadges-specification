...
* First, launch the [IMS Conformance Test Suite](https://certification.imsglobal.org/certification/badgeconnect/launch.html) for Open Badges 2.1 and follow the onscreen instructions to run the tests.
