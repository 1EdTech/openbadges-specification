...
Information is divided between badge objects that describe an individual earner's accomplishment (<a data-cite="OB-SPEC-21#Assertion">Assertion</a>), the general features of the achievement (<a data-cite="OB-SPEC-21#BadgeClass">BadgeClass</a>), and the entity or organization issuing the badge (<a data-cite="OB-SPEC-21#Profile">Issuer</a>).


<h3 id="Assertion">Assertion Example</h3>

(<a data-cite="OB-SPEC-21#Assertion">definition</a>)
...
(<a data-cite="OB-SPEC-21#BadgeClass">definition</a>)
...
(<a data-cite="OB-SPEC-21#Profile">definition</a>)
...
(<a data-cite="OB-SPEC-21#Extensions">definition</a>)
...
(<a data-cite="OB-SPEC-21#SignedBadge">definition</a>)
...
(<a data-cite="OB-SPEC-21#CryptographicKey">definition</a>)
...
(<a data-cite="OB-SPEC-21#RevocationList">definition</a>)
...
(see more about <a data-cite="OB-SPEC-21#HostedBadge">Hosted Verification</a>)
...
(<a data-cite="OB-SPEC-21#Criteria">definition</a>)
...
(<a data-cite="OB-SPEC-21#Evidence">definition</a>)
...
Evidence may be more fully described by using the <a data-cite="OB-SPEC-21#Evidence">Evidence</a> class:
<pre>
{
  "@context": "https://w3id.org/openbadges/v2",
  "id": "https://example.org/beths-robotics-badge.json",
...
(<a data-cite="OB-SPEC-21#Image">definition</a>)
