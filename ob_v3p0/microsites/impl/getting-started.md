...
-   When a client requests `Accept: application/json` or `application/ld+json`
    ...
    [Profile](/ob/specifications/ob-v3p0#profile), and a
    ...
    [Dereferencing the Public Key](/ob/specifications/ob-v3p0#dereference)
...
[Achievement Data Model](/ob/specifications/ob-v3p0#achievement) for
...
[enumeration](/ob/specifications/ob-v3p0#org.1edtech.ob.v3p0.achievementtype.class))
...
[issuer role](/ob/specifications/ob-v3p0#conformance-and-certification-guide)
to submit a downloaded signed credential like the above for conformance checks.

> **Note**: You can review Issuer's best practices in its <a href="#issuer">own section</a>.
...
> **Note**: The API of Open Badges 3.0 and Comprehensive Learner Record 2.0 defines the
...
[Open Badges API](/ob/specifications/ob-v3p0#api).
...
[token refresh](/ob/specifications/ob-v3p0#token-refresh).
