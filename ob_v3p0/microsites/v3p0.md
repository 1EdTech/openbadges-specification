...
intro: The data models in this section are shared by [[OB-30]] and [[CLR-20]].
heading: 1
```
...
intro: The data models in this section are used by the [[[#open-badges-api]]].
heading: 1
```
...
intro: The data models in this section are shared by all 1EdTech service specifications.
heading: 1
```
...
intro: Data models for the JSON Web Token Proof Format (VC-JWT) [[VC-DATA-MODEL-2.0]] shared by [[OB-30]] and [[CLR-20]].
heading: 1
```
...
title: Derived Types
intro: The derived types in this section are shared by all 1EdTech specifications.
heading: 1
```
...
intro: The primitive types in this section are shared by all 1EdTech specifications.
heading: 1
```
...
intro: The data models in this section are used by the [[[#verification-and-validation]]] process for supporting older credentials created with [[VC-DATA-MODEL-1.1]].
heading: 1
```
