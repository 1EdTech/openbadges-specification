...
### Example: JSON-LD @context serialization
...
| [AchievementCredential](#achievement-credential) | `type`             |
| [AchievementCredential](#achievement-credential) | `credentialSchema` |
| [AchievementCredential](#achievement-credential) | `proof`            |
| [AchievementCredential](#achievement-credential) | `termsOfUse`       |
