...
A Host SHOULD treat a credential as the same as another when both the [issuer](#profile) `id` and the [AchievementCredential](#achievement-credential) `id` are equal after unescaping of any percent encoded characters [[RFC3986]] followed by truncation of leading and trailing whitespace.
