...
[Proofs](/ob/specifications/ob-v3p0#data-integrity)). Two formats of
...
section on [Proofs](/ob/specifications/ob-v3p0#data-integrity). In
...
[[CASE-10]] specification defines how systems exchange and manage
...
##### Example: Achievement alignment (CASE)
...
##### Example: Achievement alignment to more information about the Credential (ceterms:Credential)
...
##### Example: Achievement alignment to a competency (ceasn:Competency)
...
##### Example: Achievement alignment to another type of entity (CTDL)
...
##### Example: Email identifier in credential subject
...
##### Example: Given name and family name credential subject with Profile
...
version of W3C's Verifiable Credentials Data Model was [[VC-DATA-MODEL-1.1]],
...
-   `https://www.w3.org/2018/credentials/v1`, for [[VC-DATA-MODEL-1.1]]
...
based on [[VC-DATA-MODEL-1.1]]. However, the displayer must also check the value
...
[[VC-DATA-MODEL-1.1]] or [[VC-DATA-MODEL-2.0]].
