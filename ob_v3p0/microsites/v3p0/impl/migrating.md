...
#### Example: OpenBadges 3.0 Achievement with linked OpenBadges 2.0 BadgeClass via related association
...
#### Example: Issuer profile relation between Open Badges 3.0 and Open Badges 2.0
...
#### Example: Issuer profile relation between Open Badges 2.0 and Open Badges 3.0
...
#### Example: Upgraded OB 2.0 assertion included within CLR 2.0
