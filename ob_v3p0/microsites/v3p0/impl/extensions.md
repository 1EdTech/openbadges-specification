...
##### Example: Sample Credential with Extension JSON-LD Context
...
> **Note**: Note the existence of `additionalProperties` to allow fields from another schemas, like the ones 1EdTech provides.
