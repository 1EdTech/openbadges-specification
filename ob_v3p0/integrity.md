...
<div class="note">
  Whenever possible, you should use a library or service to create and verify a Linked Data Proof. For example, Digital Bazaar, Inc. has a GitHub project that implements the [[[VC-DI-EDDSA]]] Ed25519Signature2020 suite at [https://github.com/digitalbazaar/ed25519-signature-2020](https://github.com/digitalbazaar/ed25519-signature-2020).
</div>
...
1. Create an instance of [Ed25519VerificationKey2020](#ed25519verificationkey2020) as shown in [Section 2.1.2 Ed25519VerificationKey2020](https://www.w3.org/TR/vc-di-eddsa/#ed25519verificationkey2020) of [[VC-DI-EDDSA]].
1. Using the key material, sign the credential object as shown in [Section 7.1 Proof Algothim](https://w3c-ccg.github.io/data-integrity-spec/#proof-algorithm) of [[DATA-INTEGRITY-SPEC]] to produce a [Proof](#proof) as shown in [Section 2.2.2 Ed25519 Signature 2020](https://www.w3.org/TR/vc-di-eddsa/#ed25519signature2020) of [[VC-DI-EDDSA]] with a \`proofPurpose\` of "assertionMethod".
